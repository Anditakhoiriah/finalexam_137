...
import pws.a.finalexam.exceptions.NonexistentEntityException;
import pws.a.finalexam.exceptions.PreexistingEntityException;
...
public class SuratJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("pws.a_finalexam_jar_0.0.1-SNAPSHOTPU");
